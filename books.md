...
Цифровая эпоха диктует свои правила обеспечения национальной безопасности в тесной увязке с международной. В книге системно рассматриваются мегатренды развития ИКТ как локомотива социализации человечества, а также сетевая мощь государств.
...
С учетом стремительных процессов информационной глобализации работа может быть полезна для широкого круга читателей, интересующихся столь актуальными направлениями российской и мировой политики.
...
Автор Стивен Прата
Год издания 2007
ISBN 5-8459-1 1 27-3
Язык Русский

Эта классическая работа по вычислительной технике обучает принципам программирования, среди которых структурированный код и нисходящее проектирование, а также использованию классов, наследования, шаблонов, исключений, лямбда-выражений, интеллектуальных указателей.
...
Базовое учебное пособие для изучения языка программирования Java с нуля.
...
Многие люди не задумываются о своей анонимности, а если и задумываются, то слишком поздно. А зря. Ведь желающих покопаться в чужом грязном белье уйма. Но для многих сложно не то что обеспечить себе базовую анонимность, а даже просто переустановить Windows. А у кого то и компа/ноутбука нет. Только телефон на базе Android. Но и на нем можно добиться анонимности.
...
Книга создана с целью научить использовать Python для судебной экспертизы таким образом, чтобы читатели, которые практически не имели опыта программирования, могли сразу следовать и разработать практический код для использования в делах.
...
Kali Linux - это платформа тестирования и проверки безопасности проникновения с расширенными возможностями инструменты для выявления, обнаружения и использования любых уязвимостей.
...
Daniel W. Dieterle работает в области информационных технологий более 20 лет. За это время он предоставил системную и сетевую поддержку для сотен компаний в штате Нью-Йорк и во всей Северной Пенсильвании.
...
Содержание призвано помочь тестировать свою собственную систему против угроз информационной безопасности и защищать свои ИТ-системы инфраструктуры от атак.
...
Автор Джон Эриксон
Формат PDF
ISBN 978-5-93286-158-5, 978-1-59327-144-2
Год издания 2010
Язык Русский
...
Willie L. Pritchett has a Master's in Business Administration. He is a seasoned developer and security enthusiast who has over 20 years of experience in the IT field.
...
Прекрасные схемы и фото с техникой вскрытия замков. Книга не нова, но и замки те же, а все что новее можно уже найти на видеохостингах, но вот азы брать из книг.
...
Подробный мануал Google Hacking, можно сказать вытяжка и редакция всей книги - Google Hacking автор этот же, ISBN 13: 978-1-59749-176-1, нет смысла качать саму книгу когда тут все более актуальное и без лишнего наполнения, создана после 2008 года но это руководство по сей день полезно и работоспособно.
...
В этой книге рассказывается, как превратить малину Pi в арсенал взлома, чтобы использовать самый популярный инструментарий с открытым исходным кодом Kali Linux. Вы узнаете, как использовать различные инструменты для нарушения сетей и кражи данных.
...
Автор одной из самых читаемых в мире книг по прикладной криптографии Брюс Шнайер на пальцах объясняет, почему безопасность в интернете — это миф. Ответы на вопросы, почему так сложно скрыть личную цифровую информацию от третьих глаз, здесь соседствуют с практическими алгоритмами безопасного хранения данных. Бесценная книга для тех, кто считает, что владеет ценными сведениями.
...
Формат PDF
ISBN 978-5-8459-0842-1
Год издания 2008
Язык Русский

В этом издании Вы найдёте информацию по сетевым технологиям с ответами на вопросы. Прочтёте о коммутаторах,концентраторах,маршрутизаторах и многом другом. Будете знать о кабельных системах,их проектировании. Подготовка к экзамену в рамках Академии Cisco
...
брандмауэров iptables и ebtables, прокси-серверов Squid и SquidGuard, созданию chroot-
окружения, управлению доступом с помощью системы Tomoyo, настройке VPN-сервера, аудиту
...
созданию LiveCD, автоматизации задач с помощью bash, использованию программных RAID-
массивов.
...
В учебном пособии рассмотрены теоретические основы построения систем поддержки принятия решений: методология системного анализа и исследования операции. Теоретический материал дополнен примерами и задачами с решениями, вопросами и тестами для проверки усвоения материала.
...
Автор EC-Council
Формат PDF
ISBN 978-1-4354-8361-3
Год издания 2009
Язык English

This certification covers a plethora of offensive security topics ranging from how perimeter defenses work, to scanning and attacking simulated networks. A wide variety of tools, viruses, and malware is presented in this and the other four books, providing a complete understanding of the tactics and tools used by hackers. By gaining a thorough understanding of how hackers operate, an Ethical Hacker will be able to set up strong countermeasures and defensive systems to protect an organization's critical infrastructure and information.
...
В данной книге автор детально описывает способы тестирования на проникновение.
Охватывается максимально-возможная область этичного хакинга с примерами и приёмами эксплуатации уязвимостей.
Книга будет полезна как новичкам,так и профессиональным специалистам в области информационной безопасности.
...
This workbook covers all the information you need to pass the EC-Council's Certified Ethical Hacking 312-50 exam. The workbook is designed to take a practical approach to learning with real-life examples.
...
What is the relationship between cyber activities conducted by Russia at home and abroad? What role do cyber operations play as an instrument of Russia’s coercive diplomacy? How different is Russia from other cyber powers, and how do we know for sure if the Kremlin is behind certain cyberattacks that have been attributed to it? This Chaillot Paper examines these and other key questions as it explores how Russia’s increasingly assertive behaviour in cyberspace has lent new urgency to the debate about cybersecurity in the West. It focuses on what lessons EU member states have learned from recent events, and on how the EU and NATO have responded to these cyber challenges on the diplomatic, political and security fronts. The paper argues that Russia’s aggressive use of cyber tools has led the US and many Europeans states to adopt more defensive cyber strategies, and that as a result Russia may have lost the strategic advantage it has hitherto enjoyed in what is becoming an ever-more contested domain.
...
Предлагаемая книга рассчитана на две категории читателей. Во-первых, на пользователей IBM-совместимых ПЭВМ, столкнувшихся с неприятностями, вызываемыми компьютерными вирусами. Во-вторых, на профессиональных и начинающих вирусологов. Приведено описание множества вирусов.
...
В книге описаны методы создания эффективных антивирусных программ-детекторов и фагов. С этой целью рассмотрены принципы функционирования некоторых типов вирусов и приведен ассемблерный текст простейшего СОМ-вируса с подробным рассказом о фазах создания вируса и о работе отдельных его частей. Приведен также текст антивирусной программы. Подробно описан процесс создания программы-антивируса, показана практическая работа вируса и антивируса в среде MS DOS для IBM PC совместимых компьютеров. В конце книги дана краткая аннотация ряда публикаций по вирусам и антивирусам. Книга рассчитана на программистов различных уровней подготовки и на пользователей IBM-совместимых компьютеров.
...
Faster: 100 Ways to Improve Your Digital Life contains all the tips and tricks for you to stretch the limits of emails, computers, social networks, video sites and everything else digital. With easy-to-use examples and loads of screen shots, Fast is the perfect digital companion for you
...
Весьма интересная книга, которая будет полезна как для новичков, так и для опытных web-разработчиков посвященная вопросам безопасности интернет-приложений. Приложение содержит задачи на проникновение в тестовые системы. Материал актуален и содержит примеры и описания ошибок в основном для PHP-скриптов, но в небольшом объеме параллельно рассматриваются и Perl-скрипты.
...
Основная суть данной книги в том, чтобы объяснить подробнее, что такое Социальная Инженерия и как ее использовать. Она подойдет новичкам. Но это не значит, что ее не могут читать опытные люди.
...
В монографии рассмотрены вопросы поиска информации в сети Интернет. Проведён анализ существующих подходов к решению этих вопросов, применяемых при этом методов и алгоритмов. Приведены универсальные и специализированные программные средства и системы, осуществляющие поиск информации в глобальной сети, указаны их достоинства и недостатки. Классифицированы подходы, методы, алгоритмы и использующие их системы поиска информации в сети, а также предложен оригинальный подход к поиску ответов на вопросы в Интернете. Монография предназначена для научных сотрудников и специалистов в области информационного поиска. Ключевые слова: алгоритмы поиска, поиск информации, поисковые системы, сеть Интернет, концептуальные подходы и методы поиска, вопросноответные системы.
...
Учебное пособие предназначено для изучения основных разделов обще-профессионального курса «Технические средства защиты информации». Для студентов высших учебных заведений специальностей «Организация и технология защиты информации» и «Комплексная защита объектов информатизации».

Помехозащищенность систем связи с псевдослучайной перестройкой рабочей частоты

Автор Макаренко С.И. Иванов М.С. Попов С.А.
Формат PDF
ISBN 978-5-4386-0166-1
Год издания 2013
Язык Русский
...
Конспект с примерами и упражнения с задачами. Данный курс рассчитан на слушателей, которые уже имеют начальные навыки программирования для ядра Linux, и их целью является только совершенствование в этом предмете. Основной целью является не показ иллюстрирующих кодов, а формулирование задач для самостоятельной проработки, и последующее обсуждение их решений.
...
Практически эта книга предоставляет экспертные рекомендации по обнаружению и использованию недостатков в мобильных приложениях на платформах iOS, Android, Blackberry и Windows Phone. Вы изучите проверенную методологию оценки мобильных приложений.
...
В этой книге описаны различные популярные инструменты тестирования на проникновение, и, таким образом, она служит источником информации как для профессионалов в области безопасности, так и для начинающих.
...
Более 90 практических рецептов, объясняющих, как использовать пользовательские скрипты, и интегрированные инструменты в Kali Linux для эффективного управления сетевым сканированием.
...
Подробная методика пентестинга WEB серверов, в примерах.
...
Пошаговое руководство, как взломать Facebook используя методы социальной инженерии в DracOs социальная инженерия (социальная инженерия) является наиболее широко используемой техникой в используется злоумышленниками для получения информации о жертве.
...
В этом руководстве вдвое больше контента, чем в сравнении с его предшественником. В нем также описывается создание лаборатории, анализируются контрольные примеры для атак и предоставляется более специализированный код.

The Art of Memory Forensics - Detecting Malware and Threats in Windows, Linux, and Mac Memory

Автор Michael Hale Ligh, Andrew Case, Jamie Levy, AAron Walters
Формат PDF
ISBN 978-1-118-82499-3
Год издания 2014
Язык English
...
В данной книге я предлагаю сделать небольшой пробег по нескольким темам. Таким как создание простых вирусов, типичные уязвимости сайтов и социальная инженерия для начинающих. Книга в активной разработки и требует дополнений/предложений от пользователей. Все желаемые темы и редакции будут добавляться по истечению времени. Здесь вы сможете ознакомится с базой знаний с которой делал первые шаги сам автор. Можно сказать она дает небольшое представление и небольшое количество опыта о хакинге современного мира. Взломы, создание вирусов и обман человеческого мозга лежит здесь.
...
SQL-инъекция является одним из многих типов веб-атак. Злоумышленник может отправить запрос с помощью вредоносных операторов SQL, которые затем выполняются сервером базы данных. Успешный эксплойт с использованием SQL-инъекций Attacker может считывать конфиденциальные данные из базы данных, изменять данные базы данных (вставка / обновление / удаление), выполнять операции администрирования базы данных (например, отключение СУБД), считывать / записывать файлы в систему, выполнять команды.Все подробно описано в этой книге.
...
Эта книга специально предназначена для тестировщиков на проникновение, консультантов по безопасности, специалистов по информационной безопасности и хакеров.
...
Хотите освоить Nmap и его скриптовый движок? Тогда эта книга для вас - она содержит практические задания и точные инструкции, представляет собой всеобъемлющее руководство по тестированию на проникновение и мониторингу сети.
...
Вы узнаете о сборе информации о цели, социальной инженерии, захвате сетевого трафика, анализе уязвимостей, разработке эксплойтов и многом другом. В практических примерах обсуждаются даже сложные темы, такие как безопасность мобильных устройств и обход антивирусного программного обеспечения.
...
Этот ресурс описывает атаки на пользователей Web-сервера
...
Краткое руководство,примеры.Виды авторизации.
...
Основные методы с примерами эксплуатации Web серверов.
...
Виды атак: Индексирование директорий,Идентификация приложений,Утечка информации и.т.п.
...
Классификации: Злоупотребление функциональными возможностями,Отказ в обслуживании.
...
Основные моменты это: Подбор (Brute Force),Недостаточная аутентификация и.т.п.
...
Реализация взлома протокола ZigBee и систем умного дома, которые на нем построены.
...
Минуем встроенную утилиту LUKS. И шифруем с помощью luksipc. Очень удобно.
...
В монографии изложены результаты научных исследований соответствующих приоритетному направлению развития науки и техники РФ – информационно-телекоммуникационным технологиям и критическим технологиям федерального уровня – информационно-телекоммуникационным системам. Методология научных исследований проблем построения средств защиты почтовых сервисов информационно-телекоммуникационных систем корпоративных предприятий с территориально-распределенной структурой может быть использована в научных исследованиях магистрантов, аспирантов по направлениям обучения: 09.04.01 – Информатика и вычислительная техника, 09.04.04 – Программная инженерия, 09.04.02 – Информационные системы и технологии.
...
В монографии с учетом последних достижений отечественных наук уголовно-правового цикла, передовой практики органов предварительного расследования системы МВД России рассмотрены проблемы совершенствования деятельности по расследованию преступлений в сфере компьютерной информации на основе широкого использования современных средств и методов компьютерного моделирования. Монография предназначена для обеспечения учебных занятий, проводимых со слушателями образовательных учреждений МВД России, а также других правоохранительных органов.
...
Курс лекций предназначен для освоения курса «Введение в специальность» студентами, обучающимися по специальности «Средства связи с подвижными объектами». Карьера после окончания по программы подготовки специалистов среднего звена "Средства связи с подвижными объектами". Выпускники получают квалификацию техников-технологов при базовой подготовке и специалистов по телекоммуникациям при углублённой подготовке.

Сотовые сети радиосвязи с подвижными объектами

Автор Сукачев Е.А.
Формат PDF
ISBN 978-617-582-010-0
Год издания 2013
Язык Русский
...
Глубокое погружение в технологию корпоративного наблюдения: Фонд электронных рубежей (Electronic Frontier Foundation, EFF) решает демистифицировать загадочные "трекеры", которые следят за нами на сайтах и в реальной жизни. Перевод объемной статьи от известных цифровых активистов.
...
Язык Русский
 ...
 Как создать и использовать контейнер TrueCrypt, Как создать и использовать раздел/устройство, зашифрованное TrueCrypt, и.т.д.
...
Если вы новичок в программировании на Python, начинайте с начала книги и читайте ее по порядку. По пути вы подберете хорошие строительные блоки.
...
Книга о методах программирования, позволяющих сократить количество ошибок в программном обеспечении, уменьшить сложность их исправления и внесения изменений, облегчить последующую поддержку.
...
Хорошая книга для тех, кто решил изучить язык программирования Python(версии 3).
...
Техническое руководство по установке аппаратного обеспечения маршрутизаторов Cisco серии 800 с интегрированными сервисами
...
Эта книга представляет собой маленькое руководство. В этой книге очень много актуальной информации, несмотря на то что книга 2013 года. Данная книга отлично подойдет для новичков и для всех тех кому интересна тема анонимности и конфиденциальности.
...
Этот 32-страничный cheat sheet включает более 100 полезных нагрузок и техник межсайтового скриптинга с четкими указаниями в нескольких возможных сценариях, которые помогут вам с современным XSS. Эта шпаргалка предназначена для бпгхантеров, пентестеров, аналитиков по безопасности, студентов и энтузиастов безопасности веб-приложений.
...
Автор Игорь Рызов
Формат PDF, epub, fb2,  ios.epub, mobi.prc
ISBN 978-5-04-095843-6
Год издания 2018
Язык Русский
...
Черно-белая книга в цветной мягкой обложке. Форензика, простыми словами, — это сбор цифровых доказательств. Что можно понять под словосочетанием «цифровые доказательства». Компьютерная криминалистика (Форензика). Под цифровыми доказательствами подразумевается наличие следов преступления на любых носителях информации: жесткие диски, смартфоны, планшеты, флешки, любые предметы, где может храниться информация в электронном виде. Из самых не обычных — это могут быть утюги, холодильники и прочая умная бытовая техника
