...
| Число жил,  сечение мм. | Наружный диаметр мм.| Диаметр трубы мм. | Допустимый длительный ток (А) для проводов | Макс. мощность, кВт | I max нагрузки, А | Ток автомата, А
	ВВГ 	ВВГнг 	NYM 	ПВ1 	ПВ3 	ПВХ (ПНД) 	Мет				
